...
public class City implements  Comparable {
    ...
    City(String name, Coordinates coordinates, Double area, int population, Double metersAboveSeaLevel, Float agglomeration, Government government, StandardOfLiving standardOfLiving, Human governor) {
        this.creationDate = LocalDateTime.now();
        this.id = ID;
        this.name = name;
    ...
    City(String name, Coordinates coordinates, Double area, int population, Double metersAboveSeaLevel, Float agglomeration, Government government, Human governor) {
        this.creationDate = LocalDateTime.now();
        this.id = ID;
        this.name = name;
        this.coordinates = coordinates;
    ...
    City(String name, Coordinates coordinates, Double area, int population, Double metersAboveSeaLevel, Float agglomeration, Government government) {
        this.creationDate = LocalDateTime.now();
        this.id = ID;
        this.name = name;
        this.coordinates = coordinates;
